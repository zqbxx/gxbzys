...
from gxbzys.video import VideoHead, VideoInfo, write_encrypt_video
...
class EncryptFileDialog(dialog.EncryptFileDialog):
    ...
    def __init__(self, parent=None, win_title='加密文件', before_process: Callable = not_encrypt_data,
                 processor: Callable = encrypt_data, success_msg: str = '加密完成',
                 select_file_dlg_filter: str = 'All Files (*);;Text Files (*.txt)',
                 select_file_dlg_title: str = '选择需要加密的文件', select_output_dir_title: str = '选择输出目录') -> None:
